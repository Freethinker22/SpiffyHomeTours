        ...
        <form name="passResetForm" id="passResetForm" method="post" action="PassReset">
            <ul>
                <li>
                    ...
                    <input type="text" name="txtOldPass" id="txtOldPass" class="defaultText displayNone" title="Your old password" value="Your old password" maxlength="50" /> <!-- Text typed password fields are turned on and off onfocus by JS so default text is readable -->
                ...
                <li>
                    ...
                    <input type="text" name="txtNewPass" id="txtNewPass" class="defaultText displayNone" title="Min. 8 characters" value="Min. 8 characters" maxlength="50" />
                ...
                <li>
                    ...
                    <input type="text" name="txtNewPassConf" id="txtNewPassConf" class="defaultText displayNone" title="Retype your password" value="Retype your password" maxlength="50" />
