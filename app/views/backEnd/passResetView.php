        ...
        <form name="passResetForm" id="passResetForm" method="post" action="PassReset" onSubmit="return checkFormStatus();">
            <ul>
                <li>
                    ...
                    <input type="text" name="txtOldPass" id="txtOldPass" title="Your old password" value="Your old password" maxlength="50" /> <!-- Text typed password fields are turned on and off onfocus by JS so default text is readable -->
                ...
                <li>
                    ...
                    <input type="text" name="txtNewPass" id="txtNewPass" title="Min. 8 characters" value="Min. 8 characters" maxlength="50" />
