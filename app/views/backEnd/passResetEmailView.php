        ...
        <form name="passResetForm" id="passResetForm" method="post" action="PassReset">
            <ul>
                <li>
                    ...
                    <input type="text" name="txtNewPass" id="txtNewPass" class="defaultText displayNone" title="Min. 8 characters" value="Min. 8 characters" maxlength="50" /> <!-- Text typed password fields are turned on and off onfocus by JS so default text is readable -->
