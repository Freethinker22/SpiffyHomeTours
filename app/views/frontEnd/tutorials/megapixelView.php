<section id="mainContent">
    ...
    <section id="tutorialWrapper">
        ...
        <article>
            ...
            <p>Any who, so what the heck is a megapixel and what does it mean when a camera has more of them?  Well first off, the word pixel is short for picture element.  Think of an image as a mosaic with millions of tiny dots that each have one color.  When you put enough dots together and in the right order, you get an image.  For example, when you see the screen resolution for a computer monitor, it's listed in pixels.  My monitor's resolution is 1920x1080, meaning the image it displays is 1,920 pixels wide by 1,080 pixels tall.  Multiply those two numbers together and you get the total number of pixels in the screen.  Rounding down a bit, that means my computer screen has two million pixels in it, or two megapixels (one megapixel = one million pixels).</p> 
