...
{        
	$.getJSON('tours/' + window.tourDirectory + '/config.json', function(config) // Get the config file for a specific tour, window.tourDirectory is set in mainView.php
	{
		...
		var ImgDisplay =
		{
			...
			// *** QA touch dragging
			// *** play,pause functions need debugging with new dragging code
			// *** click and drag not click, click again to drag
			// *** mouse move when in dragging mode, pointer in tweenmode
